...
func main() {
	...
	flag.StringVar(&param.CertFile, "tlsCertFile", "/opt/certs/server.pem", "x509 certification file")
	flag.StringVar(&param.KeyFile, "tlsKeyFile", "/opt/certs/server-key.pem", "x509 private key file")
	flag.Parse()
